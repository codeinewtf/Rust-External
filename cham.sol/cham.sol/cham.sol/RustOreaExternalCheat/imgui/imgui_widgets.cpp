...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
    {
        const float pad = ImMax(1.0f, IM_FLOOR(square_sz / 7.0f));
        //RenderCheckMark(window->DrawList, check_bb.Min + ImVec2(pad, pad), check_col, square_sz - pad * 2.0f);
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(5, 5), check_bb.Max - ImVec2(5, 5), ImColor(41, 40, 40), style.FrameRounding);
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(6, 6), check_bb.Max - ImVec2(6, 6), check_col, style.FrameRounding);
    }
